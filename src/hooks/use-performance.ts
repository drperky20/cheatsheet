...
export function useCancelableRequest() {
  ...
  // Define this function directly to avoid referencing it before definition
  const createRequest = useCallback(function createRequestImpl<T>(
    ...
    return requestFn(signal).catch(error => {
