...
export function CourseCard({ course }: CourseCardProps) {
  ...
  return (
    <>
      <Card className="group relative overflow-hidden border-white/10 bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl">
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <Progress
              value={course.final_score ? Math.round((course.final_score / 100) * 100) : 0}
